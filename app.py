...
with aba2:
    ...
    if len(st.session_state.historico) == 0:
        ...
        with col_g1:
            ...
            fig1 = px.bar(
                df, x='Arquivo', y='Contagem',
                color='Nivel',
                color_discrete_map={'Alta': '#00c853', 'Media': '#ff9800', 'Baixa': '#f44336'},
                labels={'Contagem': 'Parafusos', 'Arquivo': 'Imagem'},
                text='Contagem'
            )
        ...
        fig3.update_layout(
            ...
            font=dict(family='Arial'),
            xaxis_title='Imagem',
            yaxis_title='Parafusos detectados',
            legend_title='Metodo'
        )
...
st.divider()
st.markdown('<p style="text-align:center;color:#888;font-size:0.85rem">© 2026 Daniel Tavares de Franca | Bootcamp de Ciencia de Dados e Inteligencia Artificial | Residencia em IA</p>', unsafe_allow_html=True)
